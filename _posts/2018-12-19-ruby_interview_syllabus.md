...
自2018年11月在Sydney將[IT邦鐵人賽](https://ithelp.ithome.com.tw/users/20111177/ironman/1613)完賽之後，我一直在想如何將這30篇文章做最佳利用。加上訂閱我的`30天修煉Ruby面試精選30題`系列的人超乎我的想像熱烈(30篇文章，共有24人訂閱)，對於首次參加鐵人賽完賽的作者來說，是很大的鼓勵！謝謝觀眾們！
...
[原文](../../09/13/day04_ruby_interview_questions_instance_class_method.html#ruby經典面試題目-04)

## 05

`self是什麼意思？ What does self mean?`

[原文](../../09/14/day05_ruby_interview_questions_self_singleton_method.html#ruby經典面試題目-05)

## 06

`說明Ruby的三種存取限制。 3 levels of access control for Ruby methods.`

[原文](../../09/15/day06_ruby_interview_questions_public_protected_private_method.html#ruby經典面試題目-06)
...
[原文](../../09/19/day10_ruby_interview_questions_ruby_invoke_method.html#ruby經典面試題目-10)

## 11

`Ruby 的 block, proc, lamdba方法比較? What’s difference between blocks, procs and lambdas?`

[原文](../../09/20/day11_ruby_interview_questions_blocks_procs_lambdas.html#ruby經典面試題目-11)
...
`描述Ruby裡的yield用法? What is yield statement in Ruby?`

[原文](../../10/04/day19_ruby_interview_questions_yield.html#ruby經典面試題目-19)

## 20

`說明Ruby裡Enumerable的實用之處? Why Is Enumerable So Useful?`

[原文](../../10/05/day20_ruby_interview_questions_enumerable.html#ruby經典面試題目-20)

## 21

`解釋Ruby裡的True, False與Nil? Explan True and False vs. "Truthy" and "Falsey / Falsy" in Ruby?`

[原文](../../10/06/day21_ruby_interview_questions_true_false_nil.html#ruby經典面試題目-21)
...
`說明Ruby的錯誤處理機制 Rescue. Explain Error Handling in Ruby.`

[原文](../../10/25/day26_ruby_interview_exception_handling_rescue.html#ruby經典面試題目-26)

## 27

`如何設定Ruby的Hash預設值? How to set default value in hash?`

[原文](../../10/30/day27_ruby_interview_hash_default_value.html#ruby經典面試題目-27)

## 28

`Ruby的**運算子是什麼? What does ** double splat) operator do?`

[原文](../../10/31/day28_ruby_interview_double_splat.html#ruby經典面試題目-28)

## 29

`請解釋Ruby的tap method?  What is tap method in Ruby?`

[原文](../../11/01/day29_ruby_interview_tap_method.html#ruby經典面試題目-29)

## 30

`請解釋Ruby的鴨子型別(duck type)?  What is duck type?`

[原文](../../11/02/day30_ruby_interview_duck_type.html#ruby經典面試題目-30)